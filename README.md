...
**Note:** the workbook text and code comments are in Polish. An English translation may follow.

## What's inside

- **`Digital_Twin_od_zera_Practical_Workbook.docx`** — the full workbook (47 pages): runnable code, real results, and end-of-chapter exercises.
